public class aoc3 {
    public static int validPassCount = 0;
    ...
    public static void extract(String str) {
        ...
        int min = Integer.parseInt(str.substring(0, dash));
        int colon = str.indexOf(":");
        int max = Integer.parseInt((str.substring(dash + 1, colon - 1)).trim());
        char key = str.charAt(colon - 1);
        String pass = str.substring(colon + 2);
        // Finding frequency of char in pass
        int count = 0;
